...
* WARNING
As of the 15th of May, this package is now available on MELPA. As there have been breaking changes for MELPA compatibility, if you cloned this library in the past I would suggest you install it from MELPA (or I guess if you like installing from source you can pull down the latest changes). Currently the other extensions of the package are not on MELPA, although they will probably be there quite soon.
...
* Installation
  This package is on MELPA [[https://melpa.org/#/zetteldesk][file:https://melpa.org/packages/zetteldesk-badge.svg]]

  Make sure you have MELPA in your package-archives (it would really surprise me if you don't) and you can install this with ~M-x package-install~. However, currently only the main package is on MELPA. If you want the other extensions I have for the package, you will need to install them from source by cloning this repo and adding it to your load path.
