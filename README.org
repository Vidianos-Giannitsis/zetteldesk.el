...
* Getting Started
  With that out of the way, lets do a short introduction to some core features of the package.
...
* Things to do
  The main thing I am looking into doing is to set up better org-remark integration with this package as its something really interesting I haven't gone around to doing. The other really important thing is getting the more detailed documentation of everything I define, in a texinfo format.
